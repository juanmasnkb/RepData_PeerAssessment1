...
**Mean** of total number of steps per day is `r mean.day`, **median** is `r median.day`.
...
The interval  **`r max_int$interval`** has the maximum average value of steps **(`r max_int$steps.int`)**
...
The total number of **NA** is **`r na `** 
...
**Mean** of total number of steps per day is `r mean.day2`, **median** is `r median.day2`.
